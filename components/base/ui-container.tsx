...
export function UIContainer({ children, onClose, className, title }: UIContainerProps) {
  return (
    ...
    >
    <div className={cx('relative flex flex-col shadow-lg bg-white rounded-2xl min-w-[900px]', className)}>
      <div className="relative h-15 flex items-center justify-between px-2 border-b">
        ...
        <div className="flex-1 p-4 items-center justify-center">{children}</div>
      </div>
    </motion.div>
  );
}
