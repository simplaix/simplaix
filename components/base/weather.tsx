...
export function InlineWeather({
  ...
  return (
    <Button
      onClick={onClick}
      className={cx(
        'flex flex-row gap-4 rounded-2xl p-4 skeleton-bg max-w-[300px] h-auto',
        {
          'bg-blue-400': isDay,
          'bg-indigo-900': !isDay,
        }
      ...
      >
        <div className="flex flex-row justify-between items-center">
          <div className="flex flex-row gap-2 items-center">
            <div
              className={cx('size-10 rounded-full skeleton-div', {
                'bg-yellow-300': isDay,
                'bg-indigo-100': !isDay,
              })}
            />
        ...
        <div className="flex flex-row justify-between">
          {displayTimes.map((time, index) => (
            <div key={time} className="flex flex-col items-center gap-1">
              ...
              <div
                className={cx('size-6 rounded-full skeleton-div', {
                  'bg-yellow-300': isDay,
                  'bg-indigo-200': !isDay,
                })}
              />
