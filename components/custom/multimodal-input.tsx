...
const suggestedActions = [
  {
    title: 'What is my latest ',
    label: 'unread email?',
    action: 'What is my latest unread email?',
  },
  {
    title: 'Summarize my latest',
    label: 'email and reply to it.',
    action: 'Summarize my latest email and reply to it',
  },
];
          ...
          <div className="grid sm:grid-cols-2 gap-2 w-full">
            {suggestedActions.map((suggestedAction, index) => (
              ...
              >
                ...
                >
                  <span className="font-medium line-clamp-2 w-full">{suggestedAction.title}</span>
